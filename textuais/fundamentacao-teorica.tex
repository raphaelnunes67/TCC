...
\begin{itemize}
	...
	\item \textbf{Tópicos, \textit{publish} e \textit{subscribe}}: O ato de um cliente enviar uma mensagem é chamado \textit{publish}. E subscribe para um tópico e para receber mensagens será necessário fazer o subscribe de um tópico. Os níveis de um tópico são separados por “/”. 
