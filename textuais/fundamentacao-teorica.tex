...
\subsubsection{O efeito Hall}

O efeito Hall é um fenômeno de condução diferente para diferentes portadores de carga. Na maioria das aplicações elétricas comuns, a corrente convencional é usada em parte porque não faz diferença se você considera carga positiva ou negativa em movimento. Mas a tensão Hall tem uma polaridade diferente para portadores de carga positiva e negativa e tem sido usada para estudar os detalhes da condução em semicondutores e outros materiais que mostram uma combinação de portadores de carga negativa e positiva \cite{hyperphysics}.
