...
\begin{document}
	...
	\include{pre-textuais/naomexapretext/sumario}               			   
	...
	\include{textuais/problematica}
	\include{textuais/objetivos}
	\include{textuais/hipotese-e-justificativa}
	\include{textuais/trabalhos-relacionados}
	...
	\include{pos-textuais/citações-escondidas} % Incluir sem citar
